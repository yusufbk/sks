...
<body class="animsition">
	...
	<div class="container bgwhite p-t-35 p-b-80">
        ...
        <?php
            $a = $this->input->get('id'); 
            $query = $this->db->query("SELECT * FROM produk where id = '$a'");
        ...
        ?>
			...
			<div class="w-size14 p-t-30 respon5">
				...
				<h4 class="product-detail-name m-text16 p-b-13" name="nama" id="nama">
					<?php echo $row['nama'];?>
				</h4>

				<span class="m-text17" name="harga" id="harga">
	...
	<section class="relateproduct bgwhite p-t-45 p-b-138">
		<div class="container">
			...
			<div class="wrap-slick2">
				<div class="slick2">
        <?php
            $query2 = $this->db->query("SELECT * FROM produk where id !='$a' and kategori = '$kateg' and (iklan = 'Sky King' or iklan = 'Supreme')");
					...
					<div class="item-slick2 p-l-15 p-r-15">
						...
						<div class="block2">
							...
							<div class="block2-txt p-t-20">
								<a href="detail?id=<?php echo $rows['id'];?>" class="block2-name dis-block s-text3 p-b-5">
									<?php echo $rows['nama'] ?>
								</a>
