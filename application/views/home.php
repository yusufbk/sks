				...
				<div class="wrap_menu">
					<nav class="menu">
						<ul class="main_menu">
							...
							<li>
								<a href="<?php base_url()?>product">Shop</a>
							</li>
							...
							<li>
								<a href="<?php base_url()?>cart">Features</a>
							</li>
            ...
            <?php
				...
				<div class="item-slick1 item1-slick1" style="background-image: url(<?php echo base_url("image/".$row->gambar);?>);">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
						...
						<h2 class="caption2-slide1 xl-text1 t-center animated visible-false m-b-37" data-appear="rotateInUpRight" style="color : black; background: white">
							...
							<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
								...
								<div class="block2-overlay trans-0-4">
									...
									<div class="block2-btn-addcart w-size1 trans-0-4">
										...
										<button class="add_cart flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4" data-produkid="<?php echo $row->id;?>" data-produknama="<?php echo $row->nama;?>" data-produkharga="<?php echo $row->harga;?>">
											Add to Cart
										</button>
									</div>
								</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		$('.add_cart').click(function(){
			...
			$.ajax({
				url : "<?php echo base_url();?>index.php/c_cart/add_to_cart",
				method : "POST",
		...
		// Load shopping cart
		$('#detail_cart').load("<?php echo base_url();?>index.php/c_cart/load_cart");
