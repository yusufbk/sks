   ...
   //Cetak jika ada notifikasi
      ...
      <?php echo form_open('register');?>
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter name">
						<input class="input100" type="text" name="name" placeholder="Name" value="<?php echo set_value('name'); ?>"/>
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter e-mail">
						<input class="input100" type="text" name="email" placeholder="E-mail" value="<?php echo set_value('email'); ?>"/>
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
						<?php echo form_error('email'); ?>
					</div>                

					<div class="wrap-input100 validate-input" data-validate = "Enter address">
						<input class="input100" type="text" name="alamat" placeholder="Alamat" value="<?php echo set_value('alamat'); ?>"/>
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
						<?php echo form_error('alamat'); ?>
					</div>
                
					<div class="wrap-input100 validate-input" data-validate = "Enter Phone Number">
						<input class="input100" type="text" name="notelp" placeholder="No-telp" value="<?php echo set_value('notelp'); ?>"/>
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					...
					<div class="wrap-input100 validate-input" data-validate="Confirm password">
						<input class="input100" type="password" name="password_conf" placeholder="Confirm Password" value="<?php echo set_value('password_conf'); ?>"/>
						<span class="focus-input100" data-placeholder="&#xf191;"></span>
						<?php echo form_error('password'); ?>
					</div>
                
					<div class="container-login100-form-btn">
                        <input class="login100-form-btn" type="submit" name="btnSubmit" value="Daftar" />
					</div>
