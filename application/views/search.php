					...
					<div class="item-slick2 p-l-15 p-r-15">
						...
						<div class="block2">
							...
							<div class="block2-txt p-t-20">
                                <?php echo "<a href='detail?id=".$product->id." '>".$product->nama."</a>";?>
                                <br>
		...
		<div class="container">
			...
			<div class="wrap-slick2">
                ...
                <?php
                    ...
                    //echo $key; 
                    $query = $this->db->query("SELECT * FROM produk where nama like '%".$key."%' and iklan != 'None'");
					...
					<div class="item-slick2 p-l-15 p-r-15">
						...
						<div class="block2">
							...
							<div class="block2-txt p-t-20">
                                <?php echo "<a href='detail?id=".$row['id']." '>".$row['nama']."</a>";?>
                                <br>
								<span class="block2-price m-text6 p-r-5">
									<?php echo $row['harga']?>
								</span>
